...
class BunnyRunnerGame {
    ...
    toggleMusic() {
        ...
        if (this.musicEnabled) {
            musicBtn.innerHTML = '<span style="font-weight: bold;">♫</span>';
    ...
    async startGame() {
        ...
        if (typeof umami !== 'undefined') {
            umami.track('game-start', { difficulty: this.selectedDifficulty, platform: 'desktop' });
        }
...
return [];
    ...
    startCountdown() {
        return new Promise((resolve) => {
            ...
            // Hide touch controls during countdown (mobile only)
            const touchControls = document.getElementById('touch-controls');
            if (touchControls) {
                touchControls.classList.add('hidden');
            }
            ...
            const countdownInterval = setInterval(() => {
                ...
                if (count < 0) {
                    ...
                    setTimeout(() => {
                        ...
                        // Show touch controls when countdown ends (mobile only)
                        const touchControls = document.getElementById('touch-controls');
